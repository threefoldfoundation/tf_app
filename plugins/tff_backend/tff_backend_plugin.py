...
from plugins.tff_backend.api import investor, payment, nodes, global_stats, transactions, audit
...
class TffBackendPlugin(BrandingPlugin):
    ...
    def get_handlers(self, auth):
        ...
        authenticated_handlers = [nodes, investor, global_stats, transactions, audit]
