...
export const PAGES = [ TodoListPageComponent, TodoListOverviewPageComponent, GlobalStatsPageComponent, SeePageComponent, InvitePageComponent, SetReferrerPageComponent ];
